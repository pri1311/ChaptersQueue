...
import { setChapters, setDetails, setURL, setInitialState } from '../features/player';
  ...
  return (
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" className={styles.button} onClick={handleOnClick}>Go to Course</Button>
      </Card.Body>
    </Card>
  );
}
